                    ...
                    <div className="h-1 rounded-full bg-zinc-800" style={{ width: 60 }}>
                      <div
                        ...
                        style={{
                          ...
                          backgroundColor: cfg.color.replace('text-', '').includes('zinc')
                            ? '#52525b'
                            : cfg.color.replace('text-', '').includes('emerald')
                            ? '#10b981'
                            : cfg.color.replace('text-', '').includes('blue')
                            ? '#3b82f6'
                            : cfg.color.replace('text-', '').includes('violet')
                            ? '#8b5cf6'
                            : cfg.color.replace('text-', '').includes('red')
                            ? '#ef4444'
                            : cfg.color.replace('text-', '').includes('amber')
                            ? '#f59e0b'
                            : '#52525b',
                        }}
                      />
